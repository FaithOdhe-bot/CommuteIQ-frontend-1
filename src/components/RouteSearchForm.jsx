...
const CITIES_BY_COUNTRY = {
  ...
  nigeria: [
    ...
    { value: "asaba", label: "Asaba" }, { value: "benin city", label: "Benin City" },
  ],
};
...
const CITY_PLACEHOLDERS = {
  ...
  asaba:         { origin: "e.g. Okpanam",        destination: "e.g. Nnebisi Road" },
  "benin city":  { origin: "e.g. Uselu",          destination: "e.g. Ring Road" },
  ibadan:        { origin: "e.g. Bodija",         destination: "e.g. Ring Road" },
  "port harcourt":{ origin: "e.g. GRA Phase 2",  destination: "e.g. Rumuola" },
  mombasa:       { origin: "e.g. Nyali",          destination: "e.g. CBD" },
  kisumu:        { origin: "e.g. Nyamasaria",     destination: "e.g. CBD" },
  nakuru:        { origin: "e.g. Section 58",     destination: "e.g. CBD" },
  eldoret:       { origin: "e.g. Maili Tisa",     destination: "e.g. CBD" },
};
